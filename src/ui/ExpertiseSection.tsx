    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-purple-600">Pediatric Endocrinologist</p>
            </div>
          </div>
          ...
          <button
            onClick={() => window.location.assign('http://drmoumita.localhost:3000')}
            className="mt-6 w-full flex items-center justify-center bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-500 transition-all duration-300"
          >
        ...
        <div>
          ...
          <button
            onClick={() => window.location.assign('http://drsushovan.localhost:3000')}
